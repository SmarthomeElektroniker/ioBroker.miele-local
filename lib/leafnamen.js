...
const DeviceIdentStrings = {
    1: 'fabNumber', 3: 'techType', 4: 'matNumber',
};
...
const BeanContainerInfo = {
    1: "compartmentOne", 2: "compartmentTwo", 3: "compartmentThree",
};

/** CSContext - alle Geraete. */
const CSContext = {
    1: "programId", 2: "contextWasher", 3: "contextOven",
};

/** CSContextParametersOven - Backofen. */
const CSContextParametersOven = {
    1: "open", 2: "lock", 3: "on", 4: "level",
};

/** CSContextParametersWasher - Waschen/Trocknen. */
const CSContextParametersWasher = {
    1: "onOff", 2: "waterLevel", 3: "waterInletWay", 4: "speed", 5: "actuatorLevel",
    6: "residualMoistureResistance", 7: "rssCalibration", 8: "userInterface",
};
...
const DateTimeInfo = {
    1: "utcTime", 2: "utcOffset",
};

/** DeviceAttributesCCA - Kaffee/Garen. */
const DeviceAttributesCCA = {
    2: "milkCleaningCntr", 3: "brewUnitDegreasingCntr", 4: "manualDescalingCntr",
    5: "drinksTillDescaling", 6: "drinksTillBrewUnitDegrease", 7: "stateDescalingCartridge",
    8: "stateCleaningCartridge", 9: "stateBeanContainer", 11: "doorLock",
    12: "programsTillDescaling", 13: "minutesOfHeating",
    14: "minutesOfHeatingDescalingThreshold", 15: "levelWaterTank", 16: "freshWaterTankState",
    17: "frontPanelState", 18: "sabbatActive", 19: "descalingRequired", 20: "cleaningRequired",
    21: "traideFairModeActive", 22: "supportedProgramGroups", 23: "descalingCartridgeLevel",
    24: "cleaningCartridgeLevel", 25: "daysTillMilkCleaning", 26: "objectDataChanged",
    27: "pushToTalk", 28: "initialGrinding", 29: "opLastInstanceChanged",
...
const DeviceAttributesDWTDWM = {
    ...
    34: "showRinseAidDeficit", 35: "hygieneCounter", 36: "maxReachedTemperature",
};

/** DeviceCombiState - alle Geraete. */
const DeviceCombiState = {
    1: "applianceState", 2: "operationState", 3: "processState",
};

/** DeviceContext - alle Geraete. */
const DeviceContext = {
    1: "state", 6: "deviceAttributesDwtdwm", 7: "prog", 8: "deviceAttributes",
    11: "mobileStartActive", 12: "showMeHowId", 13: "requestTimeSync",
};

/** DeviceIdent - alle Geraete. */
const DeviceIdent = {
    1: "deviceType", 2: "protocolType", 5: "supportedApps", 9: "rfVariant",
};
...
const DeviceState = {
    1: "mainState", 2: "remoteEnable", 3: "programType", 4: "programId", 5: "programPhase",
    6: "startTimeRelative", 7: "remainingTime", 8: "elapsedTimeRelative",
    9: "processTemperatureSet", 10: "processTemperatureCurrent", 11: "coreTemperatureSet",
    12: "coreTemperatureCurrent", 13: "signalDoor", 14: "signalInfo", 15: "spinningSpeed",
    16: "dryingStep", 17: "lightState", 18: "standbyState", 19: "field19", 20: "field20",
    21: "field21",
};
...
const Failure = {
    1: "failureCode", 2: "active", 3: "occurrenceFrequency", 4: "occurrenceTime",
    5: "operationSeconds", 6: "progId", 7: "blockNumber",
};
...
const FailureListItem = {
    1: "failureCode", 2: "presentNow",
};

/** FeatureList - alle Geraete. */
const FeatureList = {
    1: "deviceId", 2: "deviceClass", 3: "deviceSubClass", 5: "hasSearch", 6: "hasCamera",
    7: "deviceIdSubType", 131: "featureListOven",
};
...
const FileInfo = {
    1: "filename", 2: "sha256", 3: "currentSize", 4: "maxSize",
};

/** FileList - Dateisystem. */
const FileList = {
    1: "filename", 2: "sha256", 3: "description", 4: "fileAccessMode", 5: "size",
};

/** FileTransfer - Dateisystem. */
const FileTransfer = {
    1: "fileName", 2: "fileOperation", 3: "fileOperationStatus", 4: "offset", 5: "fileSize",
    6: "dataLength", 7: "data", 8: "dummy",
};

/** FileWrite - Dateisystem. */
const FileWrite = {
    1: "fileOperation", 2: "fileName", 3: "address", 4: "size", 5: "data",
};
...
const PSAttributesCCA = {
    1: "progPhase", 2: "progSubPhase", 3: "progress", 6: "displayTemperature",
    7: "displayCoreTemperature", 21: "temperatureSetpoint", 22: "moistureSetpoint",
    24: "powerSetpoint", 26: "startTime", 29: "nextActionTime",
};

/** PSContext - alle Geraete. */
const PSContext = {
    4: "contextOven", 7: "attributesOven",
};

/** PSContextParametersOven - Backofen. */
const PSContextParametersOven = {
    1: "grillLevel", 2: "moisture", 5: "level", 6: "temperature",
};
...
const Process = {
    ...
    15: "fuTemperature", 16: "energyConsumed", 17: "waterConsumedInLitres", 18: "washBlock",
    19: "washBlockIndex", 20: "hygieneCounter", 21: "totalImpulses",
    ...
    33: "sewLoadLevel", 34: "sewTotalFilledQuantityU16", 36: "sewHeatingTime",
...
const ProgramGroupRange = {
    1: "firstProgramId", 2: "lastProgramId", 3: "flags", 4: "payload",
};
...
const ProgramInstructionsCA = {
    1: "infoId", 2: "messageId", 3: "value",
};

/** ProgramList - alle Geraete. */
const ProgramList = {
    1: "valid", 2: "programIds", 3: "remainingTime", 4: "temperature", 5: "temperatureInfo",
};

/** RemoteEnable - alle Geraete. */
const RemoteEnable = {
    1: "remoteControlSetting", 2: "actualControl", 3: "smartGridControl", 4: "mobileControl",
};
...
const SfValue = {
    1: "sfId", 2: "validity", 3: "valueInterpretation", 4: "currentValue", 5: "min", 6: "max",
    7: "default", 8: "listRef", 9: "stepSize", 10: "extValue", 11: "fineAdjusted",
};

/** SfValueList - alle Geraete. */
const SfValueList = {
    1: "validCount", 2: "valid",
};

/** SoftwareBuild - Waschen/Trocknen. */
const SoftwareBuild = {
    1: "date", 2: "time", 3: "id", 4: "version",
};

/** SuperVisionListConfig - Kommunikationsmodul. */
const SuperVisionListConfig = {
    1: "active", 2: "onErrorOnly", 3: "isTimeMaster",
};

/** SuperVisionListItem - Kommunikationsmodul. */
const SuperVisionListItem = {
    1: "deviceId", 2: "deviceIdEnum", 3: "deviceName", 4: "connectionState",
    5: "displaySetting", 6: "signalSetting", 7: "superVisionActivate",
    8: "superVisionDisplayScreenEnum", 9: "superVisionDisplayTextEnum", 10: "utcTime",
    11: "timeOffset", 12: "processData", 13: "programType", 14: "programPhase",
    15: "signalDoor", 16: "signalInfo", 17: "longAddress", 18: "remoteEnable",
    19: "standbyState", 20: "field20", 21: "field21", 22: "field22", 23: "field23",
    24: "programId",
};

/** SupportedApplications - alle Geraete. */
const SupportedApplications = {
    1: "mieleAtHome", 2: "remoteVision", 3: "superVision", 4: "smartGrid", 5: "mobileControl",
    6: "unknown1", 7: "unknown2", 8: "voiceControl", 9: "unknown3", 10: "featureList",
    11: "washToDry",
};

/** UpdateContainerInformation - Kommunikationsmodul. */
const UpdateContainerInformation = {
    1: "updateState", 2: "field2", 3: "field3", 4: "field4", 5: "field5", 6: "field6",
    7: "field7", 8: "field8", 9: "field9", 10: "field10", 11: "crc32",
};

/** UpdateControl - Kommunikationsmodul. */
const UpdateControl = {
    1: "updateState", 2: "filename", 3: "flashAccessible", 4: "progress",
};

/** UserRequest - alle Geraete. */
const UserRequest = {
    1: "requestId", 2: "parameter0", 3: "parameter1",
};

/** XkmConfigIp - Kommunikationsmodul. */
const XkmConfigIp = {
    1: "ipAuto", 2: "ipAddress", 3: "subnetMask", 4: "gatewayAddress", 5: "dnsServerAuto",
    6: "dnsServer1", 7: "dnsServer2", 8: "wifiKey", 9: "wifiSsid", 10: "wifiSecurityType",
    11: "wifiChannel",
};

/** XkmConfigSsidList - Kommunikationsmodul. */
const XkmConfigSsidList = {
    1: "ssid", 2: "wlanSecurity", 3: "rssi", 4: "wifiChannel",
};

/** XkmIdent - Kommunikationsmodul. */
const XkmIdent = {
    2: "applicationType", 3: "moduleType", 4: "softwareVersion", 5: "softwareId",
    6: "macAddressWifi", 7: "applicationScope", 8: "macAddressLan",
};

/** XkmIdentLabel - Kommunikationsmodul. */
const XkmIdentLabel = {
    1: "serialNumber", 2: "fabricationNumber", 3: "technicalType", 4: "materialNumber",
};

/** XkmStateInfo - Kommunikationsmodul. */
const XkmStateInfo = {
    1: "state", 2: "signalQuality", 3: "systemState", 4: "requestActive", 5: "requestState",
    6: "syncState", 7: "configState", 8: "cloudStatus", 9: "connectedClients",
    10: "connectedSystemPeripherals", 11: "wifiFreqRange", 12: "wifiChannel", 13: "rssi",
    14: "bssid", 15: "bluetoothState",
};
...
const UNTERSTRUKTUR = {
    ...
    DeviceContext: { 1: "DeviceCombiState", 6: "DeviceAttributesDWTDWM", 7: "PSAttributesCCA", 8: "DeviceAttributesCCA" },
...
module.exports = { TABELLEN, LEAF_STRUKTUR, UNTERSTRUKTUR, GENERIC, WERT_INDEX, WEITERE_LEAFS,
                   feldNameIn, strukturVon, istGeneric };
