'use strict';
// Klartext-Dekodierung. Die Tabellen und die Zuordnung Geraetetyp -> Tabelle stammen aus
// Home Assistant (homeassistant/components/miele/const.py, Apache-2.0, (c) Home Assistant
// Authors), uebernommen ueber ha-miele-at-lan (custom_components/miele_lan/enums.py und
// sensor.py, MIT, (c) 2026 tiehfood). Abgeglichen mit ioBroker.miele-unbound
// (src/lib/definitions.ts, MIT, (c) 2026 meistermopper). Eigene Ergaenzungen sind im Text
// gekennzeichnet (etwa die 200er-Reihe der Spuelmaschinen).
//   https://github.com/home-assistant/core - Apache License 2.0
//   https://github.com/tiehfood/ha-miele-at-lan - MIT License
//
// ANMERKUNG ZU StateStatus 12 ("service"), am Geraet geprueft am 25.08.2026:
// Der Wert meldet nicht, dass das Geraet gewartet wird, sondern dass jemand am Geraet das
// EINSTELLMENUE geoeffnet hat - dort stehen Uhrzeit, Kindersicherung und aehnliches. Er steht
// an, solange das Menue offen ist, und verschwindet beim Verlassen.
//
// Die Waschmaschine zeigt denselben Vorgang anders: Waehrend das PIN-Eingabefeld erscheint,
// bleibt Status auf 1, dafuer wird die Programmwahl verworfen (ProgramID 0, ProgramType 4,
// SpinningSpeed 0, TargetTemperature -32766).
//
// An der WASCHMASCHINE gab es einen Verdacht auf StateProgramType 4 bei aktivem PIN-Code. Vier
// Messungen am 25.08.2026 haben ihn nicht belegt: Die einzige Messung mit PIN unterschied sich
// vom Vergleichsfall nicht nur im PIN, sondern auch im Betriebszustand. Nicht weiterverfolgt -
// die Kindersicherung wird stattdessen ueber das vorgeschaltete Relais geloest (ioBroker-Skript
// "Kindersicherung_Geraete"), was geraeteunabhaengig funktioniert und sicher schaltet.
// Am Backofen bleibt ProgramType ohnehin unveraendert.
//
// RemoteEnable, erstes Byte: Bit 3 (Wert 8) kommt mit dem Einschalten des Geraets dazu -
// [7,1,0] ausgeschaltet, [15,1,0] eingeschaltet. Es hat mit der Sperre nichts zu tun.
...
const TABLES = {
    ...
    DishWasherProgramId: {
        ...
        42: 'tall_items',
        44: 'power_wash',
        // 200er-Reihe: G5840 (eigene Messung) und G7771 (Issue #13). Die Modelle nummerieren
        // nicht gleich - Automatic ist am G5840 202, am G7771 201.
        200: 'eco',
        201: 'automatic',
        202: 'automatic',
        203: 'comfort_wash',
    ...
    // Dampfgarer mit Mikrowelle (45)
    SteamOvenMicroProgramId: {
        '-1': 'no_program',
        0: 'no_program',
        8: 'steam_cooking',
        19: 'microwave',
    ...
    // Backofen mit Mikrowelle (13)
    ProgramPhaseMicrowaveOvenCombo: {
        0: 'not_running',
    ...
    // Saugroboter (23)
    ProgramPhaseRobotVacuumCleaner: {
        0: 'not_running',
...
/*
 * Nummern und Zuordnung wie in Home Assistant (MieleAppliance, ha-miele-at-lan sensor.py).
 * Bis 0.3.40 stimmten hier vier Eintraege nicht: 16 stand als Dampfbackofen (ist die Mikrowelle),
 * 67 als Waermeschublade (ist der Dialoggarer; die Schublade ist 25), der Waschtrockner (24) nahm
 * die Programme des Trockners, und 13 die Phasen des Backofens. Geprueft war davon nie etwas -
 * an den eigenen Geraeten (Waschmaschine, Spuelmaschine, Backofen) faellt es nicht auf.
 */
const BY_TYPE = {
    1: { program: 'WashingMachineProgramId', phase: 'ProgramPhaseWashingMachine' }, // Waschmaschine
    3: { program: 'WashingMachineProgramId', phase: 'ProgramPhaseWashingMachine' }, // Waschmaschine Semi-Prof
    5: { program: 'WashingMachineProgramId', phase: 'ProgramPhaseWashingMachine' }, // Waschmaschine Prof
    2: { program: 'TumbleDryerProgramId', phase: 'ProgramPhaseTumbleDryer' }, // Trockner
    4: { program: 'TumbleDryerProgramId', phase: 'ProgramPhaseTumbleDryer' }, // Trockner Semi-Prof
    6: { program: 'TumbleDryerProgramId', phase: 'ProgramPhaseTumbleDryer' }, // Trockner Prof
    24: { program: 'WashingMachineProgramId', phase: 'ProgramPhaseWasherDryer' }, // Waschtrockner
    7: { program: 'DishWasherProgramId', phase: 'ProgramPhaseDishwasher' }, // Spülmaschine
    8: { program: 'DishWasherProgramId', phase: 'ProgramPhaseDishwasher' }, // Spülmaschine Semi-Prof
    9: { program: 'DishWasherProgramId', phase: 'ProgramPhaseDishwasher' }, // Spülmaschine Prof
    12: { program: 'OvenProgramId', phase: 'ProgramPhaseOven' }, // Backofen
    13: { program: 'OvenProgramId', phase: 'ProgramPhaseMicrowaveOvenCombo' }, // Backofen mit Mikrowelle
    15: { program: 'OvenProgramId', phase: 'ProgramPhaseSteamOven' }, // Dampfgarer
    16: { program: 'OvenProgramId', phase: 'ProgramPhaseMicrowave' }, // Mikrowelle
    31: { program: 'OvenProgramId', phase: 'ProgramPhaseSteamOvenCombi' }, // Dampfbackofen
    45: { program: 'SteamOvenMicroProgramId', phase: 'ProgramPhaseSteamOvenMicro' }, // Dampfgarer mit Mikrowelle
    67: { program: 'OvenProgramId', phase: 'ProgramPhaseOven' }, // Dialoggarer
    73: { program: 'OvenProgramId', phase: 'ProgramPhaseSteamOven' }, // Dampfgarer (MK2)
    17: { program: 'CoffeeSystemProgramId', phase: 'ProgramPhaseCoffeeSystem' }, // Kaffeevollautomat
    23: { program: 'RobotVacuumCleanerProgramId', phase: 'ProgramPhaseRobotVacuumCleaner' }, // Saugroboter
    25: { program: 'DishWarmerProgramId', phase: 'ProgramPhaseWarmingDrawer' }, // Wärmeschublade
};

/**
 * Einen Rohwert in einer Enum-Tabelle nachschlagen.
 *
 * @param {string} table   Name der Tabelle aus [TABLES]
 * @param {number} value   Rohwert des Geraets
 * @returns {string|null} Klartext oder null, wenn unbekannt
 */
 ...
 * @param v
 */
function programTypeText(v) {
    return lookup('StateProgramType', v);
}
/**
 ...
 * @param v
 */
function dryingStepText(v) {
    return lookup('StateDryingStep', v);
}
